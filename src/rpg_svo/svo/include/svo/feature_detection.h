...
public:
  ...
  virtual void detect(
      ...
      Features& fts);
//////////////////////////////////////////////////////////write by zhb
bool display_Gradpiont=false;
void detectGrad( Frame* frame,const ImgPyr& img_pyr, int max_level,Features& fts);
//////////////////////////////////////////////////////////write by zhb
int  detectGrad_cell( Frame* frame,const ImgPyr& img_pyr, 
  			int level0_gridsize,int want_piont_num,int constant_thred,
			Features& fts,float gridsize_down_ratio=2.0);

int  detectGrad_cell_level0_2( Frame* frame,const ImgPyr& img_pyr, 
  			int level0_gridsize,int want_piont_num,int constant_thred,
			Features& fts,float gridsize_down_ratio=2.0);

...
class SparseImgAlign : public vk::NLLSSolver<6, SE3>
{
 ...
 static const int patch_halfsize_ = 1;
  static const int patch_size_ = 2;
#else
...
protected:
 ...
 ///////////////////获取金字塔的scale zbh
bool change_pyr_ratio;
float pyr_ratio;
float getscale(int level,float ratio_);

vector<float> avrg_gray_dif_last_and_curframe;
void get_avrg_gray_dif_last_and_curframe(); 
//////////////////////////////////////
  // cache:

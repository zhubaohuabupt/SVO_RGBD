...
options_.max_n_kfs=10;//////////////////zbh

  overlap_kfs.reserve(options_.max_n_kfs);
//cout<<"last frame: "<<frame->last_key_frame->id_<<endl;
...
#ifdef use_grad
///////////////zhb
n_matches_+=reproject(*grid_.cells.at(grid_.cell_order[i]), frame);
///////////////////////////
#else
...
/////////////////////////////////////////////////////zhb
int Reprojector::reproject(Cell& cell, FramePtr frame)
{
  cell.sort(boost::bind(&Reprojector::pointQualityComparator, _1, _2));
  Cell::iterator it=cell.begin();
/////////////

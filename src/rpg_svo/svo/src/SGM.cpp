...
int SGM::GetDisprity_mat(cv::Mat& img11,cv::Mat &img22,int path,bool debug_display,cv::Mat &LRcheckdisp,cv::Mat &rawdisp)

{
	  ...
	  case 1:
		  ...
		  SGM_DP_L(costs_new, width, height, DMax, disp, src1, costs_L);				//cout<<"i'm here!"<<endl;											
...
int SGM::Getdisprity_float(float*left,float*right,int path,bool debug_display,int width,int height,float*lrcheckdisp ,float*rawdisp)
{

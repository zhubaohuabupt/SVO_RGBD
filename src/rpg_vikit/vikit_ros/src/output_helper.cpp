                   ...
                   tf::TransformBroadcaster& br)
{
  ...
  transform_msg.setOrigin(tf::Vector3(T.translation().x()/1, T.translation().y()/1, T.translation().z()/1));
                   ...
                   ros::Duration lifetime)
{
  ...
  msg.pose.position.x = pos[0]/1;
  msg.pose.position.y = pos[1]/1;
  msg.pose.position.z = pos[2]/1;
  pub.publish(msg);
}
